...
# Constellation stick figures — {name: [(HIP_id1, HIP_id2), ...]}
# fmt: off
_CONSTELLATIONS: dict[str, list[tuple[int, int]]] = {
    "Orion": [
...
# flat list of all line pairs for iteration
_CONST_LINES = [(h1, h2) for pairs in _CONSTELLATIONS.values() for h1, h2 in pairs]
# fmt: on
